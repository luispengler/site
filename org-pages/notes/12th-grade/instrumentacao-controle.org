...
+ Esses tipos de sensores apresentam características que dependem do conhecimento das definições abaixo
  - Normalmente aberto (NO) (NA): O transistor de saída está normalmente cortado, com o sensore desativado, assim a carga está desativada também, pois o transistor de saída está aberto.
  - Normalmente fechado (NC) (NF):
