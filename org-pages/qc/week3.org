#+TITLE: Week 3 - my own writings
#+DESCRIPTION: Week 3 - my own writings
...
#+ATTR_HTML: alt: Double-slit :title Double-slit :style margin-left: auto;margin-right: auto;background-color: mintcream;display: block;width: 50%;
...
#+ATTR_HTML: alt: Broglie-bohm :title Double-slit :style margin-left: auto;margin-right: auto;background-color: mintcream;display: block;width: 50%;
