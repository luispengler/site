...
* LOA
+ Criador de conteúdo - 2
+ Editor de Vídeo - 1
+ Gerenciador de Mídias - 1
+ Roteirista - 2
...
* Marcohort
+ Stimate how much you improved students' grades
+ Check if you want to add some other stuff
+ Check with Ronaldinho the partipants + add how many projects in fecintec
+ Briefly explain your condition today - commute to school + healt
+ Search more about stanford classes
+ Have a look at Tufts and use the strategy: apply early decision to duke or dartmouth (for instance) and then use early decision 2 from tufts -> this way you get more chances hehe
