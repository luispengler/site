...
+ Classical physics: things are either waves or particles. Which of them should I use to describe what I see in my experiments?
...
+ Double-slit experiment is used to decide if quantum objects behave like a wave or a particle.
  (show double slit experiment)

  - Particles would leave two lines on the wall behing the two slits (discrete spots and no interference)

  - Waves would leave a pattern of bright and dark lines, some waves are amplifying one another, while others waves are canceling out (interference).
