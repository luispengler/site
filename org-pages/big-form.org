...
+ Prompt: Which major would you like to pursue and why? Even if you are undecided, tell us why. Please provide details. (250 - 500 words)
  ...
  When I was 14, I got surprised how Linux based operating systems made all the crappy computers I ever owned seem like they could have a new life. Simply learning how I could use this OS with more efficiency helped me see the bigger picture. Just like operating systems, computers are a tool. And the better a tool becomes, more efficiently we are able to solve our unique set of problems. Be it improving chaotic system simulations for whether forecast or providing assistance in solving united nations' Zero Hunger Goal.
  Quantum Computers will be the way to go in the future, at least for simulations (which we can use to solve the world biggest problems). A cool thing about this growing field is that it is really multidisciplinary. Having a degree in Physics and Computer Science would help me approach Quantum Computers in two distinct ways. Besides, I have individual interests in both fields that I could persue in the future.
...
+ Please explain why you chose the session(s) above, including your reasoning for how you ranked each session. (100 Words)
  I would be a better fit for IST and SGC programs because in the future I would like to be better prepared to use my knowledge in STEM to help make the world a better place.
