...
Many brands that design and manufacture laptops or other electronic devices aren't as focused on the consumer as you might think, and some might even use planned obsolescence as a business plan. However, framework is different.
...
By open-sourcing their firmware, software, and hardware components, they give the user back his freedom, and stimulate privacy-conserving practices. As a bigger result, they create a community of non and tech experts who love framework's products.
...
First, you need to understand that quantum computers are not devices that will help you send an email to your teacher, or being able to play 8K videos in 10 different monitors at the same time. No, quantum computers are not supposed to be a replacement for your normal computer. For the sake of understanding, let's say normal computers are classical computers.
Quantum computers have the name quantum because they use the properties of quantum mechanics to solve problems, and classical computers use the properties of classical physics to solve problems.
And the kind of problems quantum computers may be able to solve in the future is incredible: Search for life in other planets, global hunger, climate change, cyber security, vaccine development, drug discovery, and many other problems. But those problems will only be able to be solved with a quantum computer in the long-term quantum computing. For now, we need to get satisfaction by being able to simulate quantum monte-carlo, take advantage of quantum key distribuition, and play quantum chess.
Quantum computers have a huge advantage on classical computers when we are solving problems that involve too much searching or testing for classical computers to do quickly, problems that require secure encryption, or problems that require simulating quantum mechanical systems. Remember, they are not a replacement for classical computers.
If quantum computers use the properties of quantum mechanics, then what are these properties? There are 3 properties that are used the most: superposition, interference, and entanglement. All of these will sound weird to you, but with a simple ice cream analogy, I can facilitate your understanding.
Superposition is like when you go to an ice cream store. There are only two ice cream flavors in this particular store: chocolate, and strawberry. Until you say it out loud "I want a chocolate ice cream", the person taking orders will not know which one do you want. Your ice cream will be in a superposition of chocolate AND strawberry, meaning that for a moment, you actually had an ice cream that tasted two different flavors at the same time! But because this is not possible, when you finally decide which flavor you want, your magical ice cream becomes a simple chocolate one OR a strawberry one.
...
The last three paragraphs are only simple analogies about complex ideas. You will not be a university professor just by understanding them, but I hope I made myself clear in explaining the essentials of a quantum computer, what we will get if we continue developing them, and the basics behind those strange computers.
...
While Stallman has some ideas I don't agree with, his role as software freedom fighter remained since the beginning of his carrer and it is crucial to the internet as we know it today. Without him the internet would be a place 100% jeopardized by companies with interest in selling information about you. Even the way we learn programming, and science areas would be fundamentally different without someone like Richard.
