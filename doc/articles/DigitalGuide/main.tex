...
{\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north west,inner sep=0pt] at (0,0) {\includegraphics[width=\paperwidth]{background.png}}; % Background image
...
{\Large Contêm depoimentos e lista de oportunidades}\\[20pt] % Subtitle
...
\subsection{Intercâmbio diversos}\index{Lists!Intercâmbio diversos}
Competições, Olimpíadas, Feiras Científicas e Conferências
Programas de bolsa e mentoria
